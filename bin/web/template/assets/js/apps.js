...
var handleMenus = function () {
    ...
    $(document).on('click', '[data-click="manifestos"]', function () {
        handleCheckPageLoadUrlfull(window.location.hash, '#ajax/nfe_manifestos.html');
        setactive(this);
    });

    $(document).on('click', '[data-click="cte"]', function () {
        handleCheckPageLoadUrlfull(window.location.hash, '#ajax/cte_ide.html');
        setactive(this);
    });

    $(document).on('click', '[data-click="logs"]', function () {
        handleCheckPageLoadUrlfull(window.location.hash, '#ajax/nfe_log.html');
        setactive(this);
    });
