...
type
   ...
   [Resource('cteremetente')]
   [Table('cteremetente')]

   TCteremetente = class(TResourceBaseClass)
   private
...
{TCteremetente }
procedure TCteremetente.ValidateBusiness(List: TObjectList<TObject>);
begin
end;
initialization

RegisterClass(TCteremetente);
