...
type
   ...
   [Resource('cterecebedor')]
   [Table('cterecebedor')]

   TCterecebedor = class(TResourceBaseClass)
   private
...
{TCterecebedor }
procedure TCterecebedor.ValidateBusiness(List: TObjectList<TObject>);
begin
end;
initialization

RegisterClass(TCterecebedor);
