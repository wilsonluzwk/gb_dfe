unit Resources.ctedestinatario;
...
type
  ...
  [Resource('ctedestinatario')]
  [Table('ctedestinatario')]

  TCtedestinatario = class(TResourceBaseClass)
  private
...
{ TCtedestinatario }
procedure TCtedestinatario.ValidateBusiness(List: TObjectList<TObject>);
begin
end;

initialization

RegisterClass(TCtedestinatario);
