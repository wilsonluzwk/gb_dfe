...
uses
  System.SysUtils, System.Generics.Defaults, System.Generics.Collections, JOSE.Types.Bytes;

type
  {$SCOPEDENUMS ON}
  TJOSEKeyCategory = (None, Symmetric, Asymmetric);

  TJOSEAlgorithmId = (Unknown, None, HS256, HS384, HS512, RS256, RS384, RS512, ES256, ES256K, ES384, ES512, PS256, PS384, PS512);
