...
uses
  System.SysUtils, System.StrUtils, System.DateUtils, System.Rtti, System.JSON;
...
begin
  ...
  case AValue.Kind of
    ...
    begin
      if SameText(AValue.TypeInfo^.NameFld.ToString, 'TDateTime') or SameText(AValue.TypeInfo^.NameFld.ToString, 'TDate') or SameText(AValue.TypeInfo^.NameFld.ToString, 'TTime') then
